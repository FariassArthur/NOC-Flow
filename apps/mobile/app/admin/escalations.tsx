      ...
      <View style={{ padding: 16, gap: 16 }}>
        ...
        <View style={{ backgroundColor: '#1e293b', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: '#334155', gap: 12 }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
            <Text style={{ color: '#f1f5f9', fontWeight: '600', fontSize: 15 }}>{editing ? 'Editar' : 'Nova'} Escalação</Text>
            <Switch
              value={form.active}
          ...
          <View style={{ flexDirection: 'row', gap: 12 }}>
            <View style={{ flex: 1 }}>
              <Text style={{ color: '#94a3b8', fontSize: 12, marginBottom: 4 }}>Tipo de Gatilho</Text>
              <View style={{ flexDirection: 'row', gap: 4 }}>
                {triggerTypes.map((t) => (
                  ...
                  >
                    <Text style={{ color: '#fff', fontWeight: '600', fontSize: 10 }}>{t === 'sla_breach' ? 'SLA' : 'Tempo'}</Text>
                  </TouchableOpacity>
                ))}
              </View>
            </View>
          ...
          <View>
            <Text style={{ color: '#94a3b8', fontSize: 12, marginBottom: 4 }}>Departamento Alvo</Text>
            <TextInput
              style={{ backgroundColor: '#0f172a', borderRadius: 8, borderWidth: 1, borderColor: '#334155', color: '#f1f5f9', paddingHorizontal: 12, paddingVertical: 8 }}
          ...
          <View>
            <Text style={{ color: '#94a3b8', fontSize: 12, marginBottom: 4 }}>Notificar Também</Text>
            <TextInput
              style={{ backgroundColor: '#0f172a', borderRadius: 8, borderWidth: 1, borderColor: '#334155', color: '#f1f5f9', paddingHorizontal: 12, paddingVertical: 8 }}
          ...
          {items.map((item) => (
            <View key={item._id} style={{ backgroundColor: '#1e293b', borderRadius: 12, padding: 12, borderWidth: 1, borderColor: '#334155' }}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
                ...
                <View style={{ paddingHorizontal: 8, paddingVertical: 4, backgroundColor: '#334155', borderRadius: 6 }}>
                  <Text style={{ color: '#94a3b8', fontSize: 10, fontWeight: '600' }}>{item.priority}</Text>
                </View>
              </View>
              <View style={{ flexDirection: 'row', gap: 6, marginBottom: 8, flexWrap: 'wrap' }}>
                <Text style={{ color: '#94a3b8', fontSize: 10, backgroundColor: '#0f172a', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 }}>
