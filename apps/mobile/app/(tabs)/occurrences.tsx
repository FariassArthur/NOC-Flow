...
export default function OccurrencesScreen() {
  ...
  const fetch = useCallback(async () => {
    try {
      ...
      const res = (await occurrenceAPI.list(params)) as Record<string, unknown>;
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#0f172a' }}>
      <ScrollView
        ...
        style={{ maxHeight: 48, borderBottomWidth: 1, borderBottomColor: '#1e293b' }}
      ...
      >
        ...
        {priorities.map((p) => (
          ...
          >
            <Text
              style={{
                color: priorityFilter === p.key ? '#fff' : '#94a3b8',
                fontSize: 13,
                fontWeight: '600',
              }}
            >
      ...
      {fetchError ? (
        ...
        <>
          <Text style={{ color: '#64748b', fontSize: 12, paddingHorizontal: 16, paddingTop: 8 }}>
            {total} ocorrência(s)
          </Text>
          <ScrollView
            style={{ flex: 1 }}
