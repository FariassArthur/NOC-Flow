    ...
    >
      <ScrollView contentContainerStyle={{ padding: 24, justifyContent: 'center', flexGrow: 1 }}>
        <View style={{ alignItems: 'center', marginBottom: 32 }}>
          <Text style={{ fontSize: 28, fontWeight: 'bold', color: '#fff' }}>CCore</Text>
          <Text style={{ color: '#94a3b8', marginTop: 6, fontSize: 14 }}>Crie sua conta</Text>
        </View>

        {error ? (
          <View
            style={{ backgroundColor: '#7f1d1d', borderRadius: 12, padding: 12, marginBottom: 16 }}
          >
        ...
        <View
          style={{ backgroundColor: '#1e3a8a', borderRadius: 12, padding: 12, marginBottom: 16 }}
        >
          <Text style={{ color: '#60a5fa', fontSize: 13, fontWeight: '600', marginBottom: 4 }}>
            ℹ️ Informação importante
          </Text>
          <Text style={{ color: '#93c5fd', fontSize: 12 }}>
            O setor NOC é reservado para administradores. Se você é um membro NOC, entre em contato
        ...
        {[
          ...
          <View key={key} style={{ marginBottom: 14 }}>
            <Text style={{ color: '#cbd5e1', fontSize: 13, marginBottom: 5, fontWeight: '500' }}>
              {label}
            </Text>
            <TextInput
        ...
        >
          {loading ? (
            ...
            <Text style={{ color: '#fff', fontWeight: '700', fontSize: 16 }}>Cadastrar</Text>
          )}
        </TouchableOpacity>
