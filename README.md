# ProjetoNOC - Network Occurrence Management System
...
pnpm --filter=@noc/api dev      # Backend (port 3001)
pnpm --filter=@noc/web dev      # Web (port 3000)
pnpm --filter=@noc/mobile dev   # Mobile (Expo)
```
...
- `pnpm --filter=@noc/web dev` - Rodar em desenvolvimento
- `pnpm --filter=@noc/web build` - Build para produção

### apps/mobile
Aplicação mobile com Expo + React Native + TypeScript
- `pnpm --filter=@noc/mobile start` - Rodar com Expo
- `pnpm --filter=@noc/mobile build` - Build para produção

### services/api
API REST com Express + MongoDB + Mongoose
- `pnpm --filter=@noc/api dev` - Rodar em desenvolvimento
- `pnpm --filter=@noc/api build` - Build para produção
